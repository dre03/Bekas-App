                                ...
                                <div class="card-body">
                                    ...
                                    <form class="row g-3" action="{{route('auth.login')}}" method="POST">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" name="username" class="form-control @error('username') is-invalid @enderror" value="{{ old('username') }}" id="username" autofocus required>
                                            @error('username')
